    ...
    <>
      ...
      <div className="sandbox-layout" style={{ marginTop: '20px' }}>
        ...
        <div className="cyber-card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px', background: 'var(--bg-card-glass)' }}>
          <h3 style={{ fontSize: '16px', fontWeight: '800', borderBottom: '1px solid var(--border-neon)', paddingBottom: '8px', color: 'var(--primary-neon)', display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 0 }}>
          ...
          <div className="code-editor-wrapper" style={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
            <div className="code-editor-header">
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                ...
                >
                  <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><Sparkles size={12} /> AI 智能诊断</span>
                </button>
                <button
                  type="button"
          ...
          {/* Tabbed Console Area */}
          <div className="terminal-window" style={{ display: 'flex', flexDirection: 'column', height: '240px', flexShrink: 0, minHeight: 0 }}>
            {/* Tab Headers */}
