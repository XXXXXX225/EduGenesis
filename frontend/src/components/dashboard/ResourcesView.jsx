...
export default function ResourcesView() {
  ...
  return (
    <>
      ...
      {!selectedNodeResources ? (
        <div style={{ padding: '24px', textAlign: 'center', background: 'var(--bg-card-glass)', borderRadius: '16px', border: '1px dashed var(--border-neon)', marginTop: '20px' }}>
          <div className="spinner-academic" style={{ margin: '0 auto 12px' }}></div>
          <h3 style={{ fontSize: '13px', fontWeight: '800', marginBottom: '6px' }}>智能资源包拼装中...</h3>
          <p style={{ color: 'var(--text-muted)', fontSize: '11px', lineHeight: '1.4' }}>正在为您唤醒主管智能体，并根据画像组装课本、思维树、测验与源码用例。</p>
        </div>
      ) : (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '16px' }}>
          ...
          {selectedNodeResources.pdf && (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ padding: '6px', background: 'rgba(2, 132, 199, 0.06)', borderRadius: '12px', border: '1px solid rgba(2, 132, 199, 0.15)', display: 'flex' }}>
                  <FileText size={18} style={{ color: 'var(--accent-cyan)' }} />
                </div>
                <span className="neon-badge neon-badge-success">PDF 生成完毕</span>
              </div>
              <div>
                <h3 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '8px' }}>《专业内容讲解课本.pdf》</h3>
          ...
          {selectedNodeResources.slide && (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ padding: '6px', background: 'rgba(29, 78, 216, 0.06)', borderRadius: '12px', border: '1px solid rgba(29, 78, 216, 0.15)', display: 'flex' }}>
                  <Video size={18} style={{ color: 'var(--secondary)' }} />
                </div>
                <span className="neon-badge neon-badge-warning">音画对齐完毕</span>
              </div>
              <div>
                <h3 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '8px' }}>《音画同步动画讲解》</h3>
                <p style={{ color: 'var(--text-muted)', fontSize: '11.5px', lineHeight: '1.6' }}>
          ...
          {selectedNodeResources.mindmap && (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ padding: '6px', background: 'rgba(180, 83, 9, 0.06)', borderRadius: '12px', border: '1px solid rgba(180, 83, 9, 0.15)', display: 'flex' }}>
                  <Map size={18} style={{ color: 'var(--warning)' }} />
                </div>
                <span className="neon-badge neon-badge-success">思维导图就绪</span>
              </div>
              <div>
                <h3 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '8px' }}>《知识点思维脑图.svg》</h3>
                <p style={{ color: 'var(--text-muted)', fontSize: '11.5px', lineHeight: '1.6' }}>
          ...
          {selectedNodeResources.quiz && (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ padding: '6px', background: 'rgba(21, 128, 61, 0.06)', borderRadius: '12px', border: '1px solid rgba(21, 128, 61, 0.15)', display: 'flex' }}>
                  <HelpCircle size={18} style={{ color: 'var(--success)' }} />
                </div>
                <span className="neon-badge neon-badge-success">测试生成就绪</span>
              </div>
              <div>
                <h3 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '8px' }}>《自适应画像评估测验》</h3>
                <p style={{ color: 'var(--text-muted)', fontSize: '11.5px', lineHeight: '1.6' }}>
          ...
          {selectedNodeResources.code && (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ padding: '6px', background: 'rgba(15, 118, 110, 0.06)', borderRadius: '12px', border: '1px solid rgba(15, 118, 110, 0.15)', display: 'flex' }}>
                  <Code2 size={18} style={{ color: 'var(--accent)' }} />
                </div>
                <span className="neon-badge neon-badge-success">代码用例生成</span>
              </div>
              <div>
                <h3 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '8px' }}>《实操代码与断言测验.py》</h3>
                <p style={{ color: 'var(--text-muted)', fontSize: '11.5px', lineHeight: '1.6' }}>
          ...
          {selectedNodeResources.video && (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ padding: '6px', background: 'rgba(251, 114, 153, 0.06)', borderRadius: '12px', border: '1px solid rgba(251, 114, 153, 0.15)', display: 'flex' }}>
                  <Video size={18} style={{ color: '#fb7299' }} />
                </div>
                <span className="neon-badge" style={{ background: 'rgba(251, 114, 153, 0.15)', color: '#fb7299', border: '1px solid rgba(251, 114, 153, 0.3)', textShadow: 'none' }}>精品视频就绪</span>
              </div>
              <div>
                <h3 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '8px' }}>《精品学习视频》</h3>
                <p style={{ color: 'var(--text-muted)', fontSize: '11.5px', lineHeight: '1.6' }}>
              ...
              <div style={{ marginTop: 'auto', borderTop: '1px solid rgba(0, 0, 0, 0.06)', paddingTop: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '10.5px' }}>
                ...
                <span style={{ color: '#fb7299', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '4px' }}>开启播放 <ArrowRight size={14} /></span>
              </div>
            </article>
          )}
